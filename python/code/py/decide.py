...
first = sys.argv[4]+"first/"
restr =u'^MLIFE版本提交checklist.xlsx|安装手册.doc|程序完成清单.xlsx|软件产品版本说明书.doc|下发清单.xls|.sql|.war|.jar|.war.zip|.doc|.docx|.xls|.xlsx|.ppt|mlifeServer.zip|mlifeWeb.zip|AppServer.zip|AppPrj.zip|paidNotice.jar|AppPay.zip|AppLt.zip|回退.sql|回滚.sql|rollback.sql|return.sql|rollback'
restr1 =u'^MLIFE版本提交checklist.xlsx|安装手册.doc|程序完成清单.xlsx|软件产品版本说明书.doc|下发清单.xls'
restr2 =u'^war.zip|.war|.jar'
restr3 =u'^回退.sql|回滚.sql|return.sql|rollback|rollBack'
restr4 =u'^mlifeWeb.zip|AppPrj.zip|paidNotice.jar|AppPay.zip|AppLt.zip|AppServer.zip|mlifeServer.zip'
...
def cop_file(path):
    ...
    for i in ls:
        ...
        if os.path.isdir(c_path):
            ...
            shutil.copyfile(c_path,first+batch+"_"+i)        
